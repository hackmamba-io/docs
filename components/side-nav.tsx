...
export default function SideNav({ items, secodaryItems }: NavProps) {
	...
	return (
		<div className='hidden lg:block h-screen w-72'>
			<nav className='pl-10 pt-10 border-r dark:border-r-slate-700 w-[15rem] h-full styled-scrollbar overflow-y-scroll fixed pb-10 max-h-[80%]'>
				<div className=''>
					{items.map((item, i) => {
						...
						if (
							...
							matchingSecondaryItem.identityKey ===
								item.identityKey
						) {
							return (
