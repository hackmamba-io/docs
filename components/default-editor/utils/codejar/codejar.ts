import { HistoryRecord, Options, Position } from "./types"

// Rip-off from https://github.com/antonmedv/codejar
export type CodeJar = ReturnType<typeof CodeJar>
export function CodeJar(editor: HTMLElement, highlight: (e: HTMLElement, pos?: Position) => void, opt: Partial<Options> = {}, w: any) {
